 ...
 * @author pr472
 */
@WebServlet(name = "LivroEditar", urlPatterns = {"/LivroEditar"})
public class LivroEditar extends HttpServlet {
    ...
    try {
        ...
        if (oLivro == null) {
            response.getWriter().println("Livro não encontrado para o ID: " + id);
            return;
        }
        ...
        e.printStackTrace();
        response.getWriter().println("Erro ao carregar livro: " + e.getMessage());
    }
    }
